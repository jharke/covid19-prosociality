...
esttab using "Tables_regressions.tex", replace ///
        width(1.0/linewidth) booktabs b(%8.3f) compress label onecell ///
        ...
        title("Table 2: H1: The COVID-19 frame increases donations. Outcome variable: donation"/label{H1/_table}) ///
        mtitles("(1)" "(2)" "(3)") ///
...
esttab modelH2_* using "Tables_regressions.tex", append ///
        width(1.0/linewidth) booktabs b(%8.3f) compress label onecell ///
        nogap nobaselevels nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
        ...
        title("Table 3: H2:  Individuals in more affected places will give more (or less) than individuals in less affected places. Outcome variable: donation"/label{H2/_table}) ///
        mtitles("(1)" "(2)" "(3)" "(4)") ///
...
esttab modelH2b_* using "Tables_regressions.tex", append ///
        width(1.0/linewidth) booktabs b(%8.3f) compress label onecell ///
        nogap nobaselevels nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
        keep(articles10 treatment) ///
        indicate("Baseline controls = $basecontrols_I" "Financial controls = $financialcontrols_I" "Health controls = $health" "Area controls = $areacontrols" `r(indicate_fe)' "Time fixed effects = $timecontrols_I", labels("Yes" "No")) ///
        title("Table 4: Number of articles about outbreaks/hotspots for a specific location and donations in the experiment. Outcome variable: donation"/label{H2b/_table}) ///
        mtitles("(1)" "(2)" "(3)" "(4)") ///
...
esttab using "Tables_regressions.tex", append ///
        width(1.0/linewidth) booktabs b(%8.3f) compress label onecell ///
        nogap nobaselevels nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
        keep(treatment $perceivedimportance) ///
        indicate("Baseline controls = $basecontrols_I" "Financial controls = $financialcontrols_I" "Health controls = $health" "Time fixed effects = $timecontrols_I", labels("Yes" "No")) ///
        title("Table 5: H3: The national project will benefit more from the COVID-19 frame than the international project. Outcome variable: share of donation to UK"/label{H3/_table}) ///
        mtitles("(1)" "(2)" "(3)" "(4)") ///
		note("Note: The sample used excludes individuals with inconsistent answers (see Online Appendix, section B); robust errors. All columns include the following baseline controls: slider initial position, age, dummy born in the UK, female dummy, socioeconomic status, number of household members, and session dummies (time fixed effects). Financial controls include monthly household income, making ends meet dummies (before the pandemic and since the pandemic), and income change dummies (since the pandemic and expected in the future). Health controls include health negatively affected by COVID-19 dummies, expected negative impact on health dummies, and vulnerability to COVID-19: high risk or moderate risk dummies.") 
...
esttab modelH4_* using "Tables_regressions.tex", append ///
        width(1.0/linewidth) booktabs b(%8.3f) compress label onecell ///
        nogap nobaselevels nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
		keep(casesnormal100 treatment) ///
        indicate("Baseline controls = $basecontrols_I" "Financial controls = $financialcontrols_I" "Health controls = $health" "Area controls = $areacontrols" `r(indicate_fe)' "Time fixed effects = $timecontrols_I", 	labels("Yes" "No")) ///
        title("Table 6: H4: Individuals in more affected places will shift their giving more to local causes than those in less affected places. Outcome variable: share of donation to UK"/label{H4/_table}) ///
        mtitles("(1)" "(2)" "(3)" "(4)") ///
...
esttab tableA4_* using "Tables_regressions.tex", append ///
        width(1.0/linewidth) booktabs b(%8.3f) compress label onecell ///
        nogap nobaselevels nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
        keep(casesnormal100 ) ///
		indicate(`r(indicate_fe)' "Time fixed effects = $timecontrols_I", labels("Yes" "No")) ///
        title("Table A4: The effect of the relative local severity of the pandemic on subjective perceptions of local severity. Outcome variable: subjective perceptions of local severity"/label{local/_severit/_table}) ///
...
esttab tableA6_1 using "Tables_regressions.tex", append ///
        b(%8.3f) compress label onecell nogap nobaselevels ///
        ...
        title("Table A6: Regional trends"/label{H2/_table}) ///
        mtitles("(1)") ///
        note("Note: See note to Table 3.")
...
esttab tableA7_* using "Tables_regressions.tex", append ///
        width(1.0/linewidth) booktabs b(%8.3f) compress label onecell ///
        nogap nobaselevels nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
        keep(casesnormal100 treatment treatment_casesnormal100) ///
        indicate("Baseline controls = $basecontrols_I" "Financial controls = $financialcontrols_I" "Health controls = $health" "Area controls = $areacontrols" `r(indicate_fe)' "Time fixed effects = $timecontrols_I", labels("Yes" "No")) ///
        title("Table A7: Interaction effect. Outcome variable: donation amount"/label{table_interaction}) ///
        mtitles("(1)" "(2)" "(3)" "(4)") ///
        note("Note: See note to Table 3.")
...
estfe tableA*, labels(location "Location fixed effect")
esttab tableA8_* using "Tables_regressions.tex", append ///
        width(1.0/linewidth) booktabs b(%8.3f) compress label onecell ///
        nogap nobaselevels nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
...
esttab tableA9_* using "Tables_regressions.tex", append ///
        width(1.0/linewidth) booktabs b(%8.3f) compress label onecell ///
        nogap nobaselevels nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
        keep(casesper100_7days treatment) ///
        indicate("Baseline controls = $basecontrols_I" "Financial controls = $financialcontrols_I" "Health controls = $health" "Area controls = $areacontrols" `r(indicate_fe)' "Time fixed effects = $timecontrols_I", labels("Yes" "No")) ///
        title("Table A9: H2: Individuals in more affected places will give more (or less) than individuals in less affected places. Alternative specification of local severity: number of COVID-19 cases in the last 7 days per 100,000. Outcome variable: donation"/label{H2/_table}) ///
        mtitles("(1)" "(2)" "(3)" "(4)") ///
        note("Note: See note to Table 3.")
...
esttab tableA10_* using "Tables_regressions.tex", append ///
         b(%8.3f) compress label  onecell nogap ///
        nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
		keep(casesnormal100) ///
...
esttab tableA11_* using "Tables_regressions.tex", append ///
		b(%8.3f) compress label  onecell nogap nobaselevels noomitted ///
        nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
...
esttab tableA13_* using "Tables_regressions.tex", append ///
        b(%8.3f) compress label  onecell nogap nobaselevels noomitted ///
        nonumbers star(* 0.10 ** 0.05 *** 0.01) se r2 ///
		keep(casesnormal100 treatment)  ///
		indicate("Baseline controls = $basecontrols_I" "Financial controls = $financialcontrols_I" "Health controls = $health" "Area controls = $areacontrols" `r(indicate_fe)' "Time fixed effects = $timecontrols_I", labels("Yes" "No")) ///
...
esttab using "Tables_regressions.tex", append ///
        b(%8.3f) compress label  onecell nogap nobaselevels noomitted ///
        nonumbers star(* 0.005 ** 0.0025 *** 0.0005) se r2 keep(treatment COVID_contribution empathy)  ///
