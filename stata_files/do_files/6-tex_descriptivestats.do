...
esttab matrix(Outcomes) using "Tables_descriptives.tex", replace ///
	tex label collabels("Mean" "Std. error" "N" "Mean" "Std. error" "N" "Mean" "Std. error" "N") ///
...
esttab matrix(Controls) using "Tables_descriptives.tex", append ///
	tex label collabels("Mean" "Std. error" "N" "Mean" "Std. error" "N" "Mean" "Std. error" "N" "T-test p-value")  ///
...
esttab matrix(B_`var') using "Tables_descriptives.tex", tex label collabels("Mean" "Std. error" "N") mtitles("`: variable label `var''") title("Table A3: Mean donations by category") append 
